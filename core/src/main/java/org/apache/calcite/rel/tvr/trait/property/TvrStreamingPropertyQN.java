...
public class TvrStreamingPropertyQN extends TvrProperty {
  ...
  public static class TvrStreamingPropertyQNSerde
    ...
    @Override public TvrStreamingPropertyQN deserialize(JsonElement json, Type typeOfT,
        JsonDeserializationContext context) throws JsonParseException {
      return TvrStreamingPropertyQN.instance;
    }

    @Override public JsonElement serialize(TvrStreamingPropertyQN src, Type typeOfSrc,
