...
public class TvrProjectTransformer extends TvrSemanticsTransformer {
  ...
  public static class TvrProjectTransformerSerde
    ...
    @Override public TvrProjectTransformer deserialize(JsonElement json, Type typeOfT,
        JsonDeserializationContext context) throws JsonParseException {
      JsonObject jsonObject = json.getAsJsonObject();
      ImmutableIntList projectRefs = ImmutableIntList.copyOf(
          c2i(context
    ...
    @Override public JsonElement serialize(TvrProjectTransformer src, Type typeOfSrc,
