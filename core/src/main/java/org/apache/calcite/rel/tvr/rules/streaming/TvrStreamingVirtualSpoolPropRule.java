...
public class TvrStreamingVirtualSpoolPropRule extends RelOptTvrRule
  ...
  public static final TvrStreamingVirtualSpoolPropRule INSTANCE =
      new TvrStreamingVirtualSpoolPropRule();

  private TvrStreamingVirtualSpoolPropRule() {
    super(
        operand(LogicalTvrVirtualSpool.class, tvrEdgeSSMax(tvr()),
        operand(
   ...
   * <p>
   *                                                   QN
   * LogicalTvrVirtualSpool --SET_SNAPSHOT_MAX-- Tvr1 ----> Tvr5  --SET_SNAPSHOT_MAX-- newVS1
   *         |                                   /   QP                                   |
   *         |                                  ---> Tvr6 --SET_SNAPSHOT_MAX-- newVS2     |
   *         |                                                                   |        |
   *         |                                  QP                               |        |
   *       input   --SET_SNAPSHOT_MAX--  Tvr2 ----> Tvr3  --SET_SNAPSHOT_MAX--  qpInput   |
   *                                          \   QN                                      |
