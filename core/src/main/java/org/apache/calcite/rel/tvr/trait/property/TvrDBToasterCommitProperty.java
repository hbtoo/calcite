...
public class TvrDBToasterCommitProperty extends TvrProperty {
  ...
  public static final TvrDBToasterCommitProperty INSTANCE = new TvrDBToasterCommitProperty();
  ...
  public static class TvrDBToasterCommitPropertySerde
    ...
    @Override public TvrDBToasterCommitProperty deserialize(JsonElement json,
        Type typeOfT, JsonDeserializationContext context)
        throws JsonParseException {
      return TvrDBToasterCommitProperty.INSTANCE;
    }

    @Override public JsonElement serialize(TvrDBToasterCommitProperty src, Type typeOfSrc,
