...
/**
 * temporary class to be compatible with code that uses the table sink operator In Calcite, there is
 * no corresponding table sink operator to represent a INSERT INTO TABLE operation
 */
public class PhysicalTableSink extends TableSink implements EnumerableRel {
  ...
  public static class TvrListTable extends AbstractQueryableTable
    ...
    @Override public TableModify toModificationRel(RelOptCluster cluster, RelOptTable table,
      ...
      return LogicalTableModify
          .create(table, catalogReader, child, operation, updateColumnList, sourceExpressionList,
              flattened);
    }
  ...
  @Override public Result implement(EnumerableRelImplementor implementor, Prefer pref) {
    ...
    Expression spoolExp =
        Expressions.call(BuiltInMethod.TVR_PHYSICAL_TABLE_SINK.method, collectionExp, inputExp);
