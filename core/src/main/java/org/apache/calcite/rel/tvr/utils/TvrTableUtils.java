...
public class TvrTableUtils {
  ...
  public static final String TVR_ESTIMATED_ROW_COUNT = "progressive.tvr.estimated.row.count";
  ...
  public static String escapeTableName(String tableName) {
    return Pattern.compile("[^0-9a-zA-Z_]").matcher(tableName).replaceAll("_")
  ...
  public static String getStateTableName(TvrContext ctx, int id, MatType matType) {
    return getStateTableName(ctx, id,
        matType == null ? "" : matType.toString().toLowerCase(Locale.ROOT));
  }
  ...
  public static class TvrTableRelation implements Serializable {
    ...
    public static final String CONFIG_INPUT_TVR_RELATED_TABLE_MAPS =
        "progressive.tvr.input.related.table.maps";
    public static final String CONFIG_OUTPUT_TVR_RELATED_TABLE_MAPS =
        "progressive.tvr.output.related.table.maps";
    ...
    public TvrTableRelation(String projectName, String tableName, String tableRowType,
        Integer partitionNum, String relDistribution, String relCollation,
  ...
  public static class TvrTableRelationUtil {
    ...
    public static TvrTableRelation of(RelDataTypeFactory typeFactory, String projectName,
        String tableName, RelDataType tableRowType, Integer partitionNum,
        RelDistribution distribution, RelCollation collation, Double estimatedRowCount) {
