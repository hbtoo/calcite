...
public class TvrStreamingPropertyQP extends TvrProperty {
  ...
  public static class TvrStreamingPropertyQPSerde
    ...
    @Override public TvrStreamingPropertyQP deserialize(JsonElement json, Type typeOfT,
        JsonDeserializationContext context) throws JsonParseException {
      return TvrStreamingPropertyQP.instance;
    }

    @Override public JsonElement serialize(TvrStreamingPropertyQP src, Type typeOfSrc,
