...
public abstract class TvrFilterRules {
  public static final TvrFilterRuleBase TVR_SET_DELTA_FILTER_RULE =
      new TvrSetDeltaFilterRule();
  public static final TvrFilterRuleBase
...
class TvrValueSemanticsFilterRule extends TvrFilterRuleBase {
  ...
  @Override public boolean matches(RelOptRuleCall call) {
    ...
    return TvrRelOptUtils.findUniqueInputRef(logicalFilter.getCondition()).stream()
